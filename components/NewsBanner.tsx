...
export default function NewsBanner({
     title = "Can the talks remove the strain in Indo-Bangladesh relations?",
     description = "Both India and Bangladesh gets an opportunity to reset mutual ties which is of late under strain following Indian foreign secretary Vikram Misri's recent visit to Dhaka. Without mincing words, Indo-Bangla ties are far less than cordial ever since the ouster of prime minister Hasina Wazed in August. It is Misri's brief to regain some public goodwill which India once enjoyed in Bangladesh. For now it is nowhere in sight. Indian foreign secretary met Mohammad Yunus heading the interim Bangla...",
     author = "Tirthankar Mitra",
     date = "11 December 2024",
     imageUrl = "/news/5.jpg",
     category = "Finance",
     slug = "/news/indo-bangladesh-relations"
