    ...
    <header>
      <div className="bg-gray-100 text-red-500 p-4">
        <div className="container mx-auto px-5 flex justify-between items-center">
          ...
          {/* Desktop Search Bar */}
          <div className="hidden md:flex items-center space-x-2 bg-white border border-gray-300 rounded-full px-6 py-2.5 shadow-sm w-[480px]">
      ...
      >
        <div className="container mx-auto px-5 py-4">
          {/* Mobile Search Bar */}
          <div className="flex items-center space-x-2 bg-gray-100 border border-gray-300 rounded-full px-4 py-2 mb-4">
            <Search className="text-gray-500" size={20} />
            <input
              type="text"
              placeholder="Search News..."
